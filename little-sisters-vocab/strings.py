...
def add_prefix_un(word):
    ...
    """
    add_prefix_word = 'un'+ word
    return add_prefix_word
...
def make_word_groups(vocab_words):
    ...
    add_prefix_to_wards = seperator.join(vocab_words)

    return  add_prefix_to_wards
...
def adjective_to_verb(sentence, index):
    ...
    if list_word[index][-1] =='.':
        list_word[index] = list_word[index][:-1]
    list_word[index] = list_word[index] + 'en'
