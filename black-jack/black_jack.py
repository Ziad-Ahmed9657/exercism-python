...
def value_of_ace(card_one, card_two):
    ...
    """
    val_one = change_value_ace(card_one) 
    val_two = change_value_ace(card_two) 

    if val_one + val_two >= 11:
        return 1
    else:
        return 11
...
def is_blackjack(card_one, card_two):
    ...
    return (card_one == 'A' and val_two == 10) or (card_two == 'A' and val_one == 10)
